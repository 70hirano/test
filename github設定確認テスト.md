...
* 以下は予想でしたが、動きが異なるため「訂正後の流れ」に、このケースでの動きを記載します
...
* ~~3‐2 リーダー：承認し、マージ可能な状態となる（マージは未だ行わない）~~
* ~~3-3 開発者：ファイルを追加修正しpushする~~
* ~~3-4 リーダー：追加pushにより承認が消える（無効化される）。マージも不可な状態となる~~
* ======================================================
* 
* **3-1実施直後の状態　→　承認が未だで、マージ不可の状態（開発者でも開発リーダーでも同じ）**
    <br /><img width="50%" height="50%" alt="image" src="https://github.com/user-attachments/assets/f1a87582-a8f9-4985-a528-29954e27726e" /><br />
* **3‐2実施直後の状態　→　マージ可能な状態**
    <br /><img width="1229" height="846" alt="image" src="https://github.com/user-attachments/assets/0b138628-20ac-4308-b5a2-eb95bc4682d1" /><br />
* **3-3実施直後の状態　→　承認が取り消され、マージ不可な状態**
    <br /><img width="50%" height="50%" alt="image" src="https://github.com/user-attachments/assets/7d2dfba2-3909-461f-abaa-1634f178cb5e" /><br />

...
* ======================================================
* ~~3-1 開発者：ファイルを修正し、開発リーダーにPRを投げる~~
* 3‐2 承認が必須ではなく、マージ可能な状態となる（開発者＆リーダー）
* 3‐3 開発者：ファイルを追加修正しpushする
* 3‐4 マージ可能な状態のまま（開発者＆リーダー）
* 3‐5 リーダー：マージする
* ======================================================
* 
* **3-1実施直後の状態　→　承認が必須ではない（＝承認済みの状態になる）のでいきなりマージ可能な状態となる（開発者でも開発リーダーでも同じ）**
    <br /><img width="50%" height="50%" alt="image" src="https://github.com/user-attachments/assets/54394d21-296f-4a6d-8daa-14617b5dfd6a" /><br />
